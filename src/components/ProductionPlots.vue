...
<script>
  ...
  export default {
    ...
    mounted() {      
      ...
      // const g = d3.select('#svg-production-plot').select('g')

      // console.log('d3 event: ', d3.event)
      // console.log('d3 event: ', currentEvent)
  ...
  //       this.updateAxesAndLinePath(xAxis, xAxisCall, yAxis, yAxisCall, xScale, yScale, g, dataArrayWithNoZeroLengthItem, pathGenerator, plotType, xAxisParam, yAxisParam, verticalLineLabel, xAxisExtremse);
  //   },
  //   updateAxesAndLinePath(xAxis, xAxisCall, yAxis, yAxisCall, xScale, yScale, g, data, pathGenerator, plotType, xAxisParam, yAxisParam, verticalLineLabel, xAxisExtremse) {
